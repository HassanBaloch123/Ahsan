#Script Given By Hassan Baloch
#Script Is Given For Educational Purpose
#Script Edited By Mounsi 
#Utf-8 .thon 
...
`-' ` `-' `----' `-----'`-' `-'`----' `-'
                                         \n\033[0m----------------------------------
\033[1;92mAuthor \033[1;93m: Mounsi
\033[1;92mFb \033[1;93m: Hassan Baloch 
...
def crack_select():
    ...
    print ' \x1b[1;94m  Wait Ids Will Appear Here \033[0m'#THANKSBRO
    print 45 * '_'
    print ''
    ...
    print '   \x1b[0m Total Ok / Cp ids : ' + str(len(oks)) + '/' + str(len(cps)) ##THANKSBRO
    print 45 * '\033[0m_\033[0m'
    print ''
    print ''
